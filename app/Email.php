...
class Email
{
	...
	function SendResolutionTimeEmail($ticket,$quote=0)
	{
		if(strlen($ticket->assignee)>0)
		{
			$this->mail->addAddress($ticket->assignee);
		}
	...
	function SendFirstContactEmail($ticket,$quote=0)
	{
		if(strlen($ticket->assignee)>0)
		{
			$this->mail->addAddress($ticket->assignee);
